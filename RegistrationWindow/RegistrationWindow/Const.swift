...
enum Const {
    ...
    static let textfieldPasswordTopAnchor: CGFloat = 20
    static let infoLabelHeight: CGFloat = 60
    static let infoLabelWidth: CGFloat = 400
    static let infoLabelBottomAnchor: CGFloat = 300
    static let infoLabelRightAnchor: CGFloat = -15
    static let greetingsLabelLeftAnchor: CGFloat = 60
    static let greetingsLabelwidthAnchor: CGFloat = 400
    static let infoLabelLeftAnchor: CGFloat = 40
    ...
    static let logginButtonRightAnchor: CGFloat = -50
    static let acceptLabelBottomAnchor: CGFloat = -30
    ...
    static let textfieldPasswordPlaceholder = "Create password"
    static let registTextFieldName = "press your name"
    static let registTextFieldPassword = "press your name"
    static let registInfoLabelText = "Welcome in Thundergram!"
    static let registSetTitle = "Registration"
    ...
    static let greetingsLabelText = "you are inside"
}
